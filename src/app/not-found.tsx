    ...
    <div className='flex min-h-screen flex-col bg-[#F8FAFC]'>
      ...
      <div className='flex grow items-center px-6 xl:px-10'>
        <div className='mx-auto text-center'>
          ...
          <p className='mt-3 text-sm leading-loose text-gray-500 lg:mt-6 lg:text-base lg:leading-loose'></p>
          <Link href={'/'}>
            <Button tag='span' size='xl' color='primary' className='mt-8 h-12 px-4 xl:h-14 xl:px-6'>
