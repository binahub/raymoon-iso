    ...
    >
        ...
        {deviceData.map((item, index) => (
          <div key={item.name} className='me-7'>
            <div className='mb-1.5 flex items-center'>
              <span className='me-2 h-2 w-2' style={{ backgroundColor: COLORS[index] }} />
      ...
      <div className='h-80 w-full @sm:pt-3 @lg:pt-8'>
        <ResponsiveContainer width='100%' height='100%'>
          ...
          >
            <defs>
              <linearGradient id='deviceSessionsMobile' x1='0' y1='0' x2='0' y2='1'>
                <stop
                  offset='5%'
                  stopColor='#F0F1FF'
              ...
              <linearGradient id='deviceSessionsDesktop' x1='0' y1='0' x2='0' y2='1'>
                <stop
                  offset='5%'
                  stopColor='#F0F1FF'
                  className='[stop-opacity:0.25] dark:[stop-opacity:0.2]'
            ...
            <Bar
              dataKey='others'
              fill={COLORS[2]}
              shape={<RoundedTopBarFill cornerRadius={4} className='dark:[fill-opacity:0.6]' />}
            />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
