...
export default function PageMetrics({ className, pageSize = 5 }: PageMetricsTypes) {
  ...
  const { isLoading, sortConfig, totalItems, tableData, currentPage, handleSort, handlePaginate } =
    useTable(pageMetricData, pageSize, filterState);
  ...
  return (
    <div
      className={cn(
        'rounded-xl border border-gray-200 bg-gray-0 p-5 dark:bg-gray-50 lg:p-7',
        className
      )}
    >
