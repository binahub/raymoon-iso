  ...
  },
  {
    title: (
      <HeaderCell
        ...
        sortable
        align='right'
        ascending={sortConfig?.direction === 'asc' && sortConfig?.key === 'users'}
      />
    ),
    ...
    width: 150,
    render: (value: number) => (
      <Text className='text-right font-medium text-gray-700 rtl:text-left'>{value}</Text>
    ),
  },
  {
  ...
  },
  {
    title: (
      <HeaderCell
        ...
        align='right'
        sortable
        ascending={sortConfig?.direction === 'asc' && sortConfig?.key === 'engagementTime'}
      />
    ),
      ...
      <>
        <div className='ms-auto h-8 w-full max-w-[280px] pe-2 lg:pe-4 4xl:h-9'>
          <ResponsiveContainer width='100%' height='100%'>
            ...
            >
              <defs>
                <linearGradient id={`deviceSessionsMobile-${row.id}`} x1='0' y1='0' x2='0' y2='1'>
                  <stop
                    offset='5%'
                    stopColor='#F0F1FF'
                  ...
                  <stop
                    offset='95%'
                    stopColor={getChartColorByEngagementRate(row.engagementRate)}
                    stopOpacity={0}
                  />
                </linearGradient>
              </defs>
