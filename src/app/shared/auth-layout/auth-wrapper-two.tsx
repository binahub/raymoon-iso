...
import { cn, Button, Avatar, Title, Text } from 'shafa-bo';
      ...
      <div className='relative z-20 flex h-full flex-col justify-between px-10 py-24 xl:px-16 xl:py-28 2xl:px-24'>
        <div className='text-white'>
          ...
          <Text className='mb-5 text-base leading-loose xl:mb-7 2xl:pe-20'>
            Sign up now and start taking advantage to a wealth of information that will help you
            improve your business and stay ahead of the competition.
          </Text>
