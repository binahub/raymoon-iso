...
const CustomizedDot = (props: any) => {
  ...
  if (value > 2500) {
    return (
      <svg x={cx - 10} y={cy - 10} xmlns='http://www.w3.org/2000/svg' width={20} height={20} viewBox='0 0 36 36'>
      ...
      <div className='mt-5 aspect-[1060/660] w-full lg:mt-7'>
        <ResponsiveContainer width='100%' height='100%'>
          ...
          >
            ...
            <Legend />
            <Line type='monotone' dataKey='pv' stroke='#3b82f6' activeDot={{ r: 8 }} strokeWidth={2} dot={<CustomizedDot />} />
