...
import { RadialBarChart as RadialBarChartComponent, RadialBar, Legend, ResponsiveContainer } from 'recharts';
...
export default function RadialBarChart({ className }: { className?: string }) {
  ...
  return (
    <WidgetCard title={'Radial Bar Chart'} className={cn('@container', className)}>
