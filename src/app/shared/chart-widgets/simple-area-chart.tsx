          ...
          >
            <defs>
              <linearGradient id='simpleAreaChart' x1='0' y1='0' x2='0' y2='1'>
                <stop offset='5%' stopColor='#3872FA' className='[stop-opacity:0.3] dark:[stop-opacity:0.2]' />
            ...
            <Area type='monotone' dataKey='uv' stroke='#3872FA' fill='url(#simpleAreaChart)' strokeWidth={2} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </WidgetCard>
