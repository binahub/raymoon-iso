...
const statusOptions = [
  {
    ...
    label: (
      <div className='flex items-center'>
        ...
        <Text className='ms-2 font-medium text-green-dark'>{STATUSES.Active}</Text>
      </div>
    ),
  },
  {
    ...
    label: (
      <div className='flex items-center'>
        ...
        <Text className='ms-2 font-medium text-red-dark'>{STATUSES.Deactivated}</Text>
      </div>
    ),
  },
  {
    ...
    label: (
      <div className='flex items-center'>
        ...
        <Text className='ms-2 font-medium text-gray-600'>{STATUSES.Pending}</Text>
      </div>
    ),
  },
];
