...
import { Title, Text, cn } from 'shafa-bo';
...
export default function ProductModernCard({ product, className }: ProductProps) {
  const { title, thumbnail, slug, description, price, sale_price, colors = [], base64 } = product;
  return (
