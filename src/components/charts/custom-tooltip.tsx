...
export function CustomTooltip({ label, prefix, active, postfix, payload, className, formattedNumber }: CustomTooltipProps) {
  if (!active) return null;

  return (
    <div className={cn('overflow-hidden rounded-md border border-gray-300 bg-gray-0 shadow-2xl dark:bg-gray-100', className)}>
