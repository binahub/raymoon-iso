...
export default function DropdownAction({ options, onChange, className }: DropdownActionProps) {
  ...
  return (
    <Select
      ...
      displayValue={(selected: any) => options.find((option) => option.value === selected)?.name}
